...
<br>
<br>
Кроме того, я подготовил ещё несколько тестовых [[картинок]](./minitests), которые проверяют проверить корректность работы кодировщика на нестандартных размерах картинки: от 18 до 27 пиксел.
